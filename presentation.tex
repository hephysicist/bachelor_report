...
\vspace*{10pt}
\centering \includegraphics[ width=0.75\linewidth]{Ampl_gr.pdf}
\end{frame}
...
\begin{columns}
	...
	\column{0.6\linewidth}
	\begin{minipage}[t][1\textheight]{\linewidth}
		\centering \includegraphics[ width=0.9\linewidth]{Test_beam_photo.jpg}
		\centering \includegraphics[ width=1\linewidth]{reg_eff_exp_scheme.png}
	\end{minipage}%
\end{columns}
\end{frame}
...
\centering \includegraphics[ width=1\linewidth]{eff_monitor.pdf}
\end{frame}

\begin{frame}
\frametitle{Эффективность регистрации}
\centering \includegraphics[ width=0.9\linewidth]{eff2K.pdf}
\end{frame}
...
\frametitle{Обработка полученных данных}
		\centering \includegraphics[ width=1\linewidth]{sp_res_monitor.pdf}
\end{frame}

\begin{frame}
\frametitle{Пространственное разрешение по горизонтали}
	\centering \includegraphics[ width=0.8\linewidth]{x_sp_res.pdf}
\end{frame}

\begin{frame}
\frametitle{Пространственное разрешение по вертикали}
		\centering \includegraphics[ width=0.8\linewidth]{y_sp_res.pdf}
\end{frame}
\begin{frame}[t]
...
\backupbegin
\begin{frame}
\frametitle{Backup: принцип работы лазерного поляриметра}
\begin{columns}
	\column{0.4\textwidth}
	\begin{minipage}[c][0.5\textheight]{\linewidth}
		\vspace{15pt}
		\small{Измеряемая величина: \\ \centering $\Delta y = \cfrac{\omega_0}{2m_e}PL\Delta V$
			}
	\end{minipage}%
	\column{0.6\linewidth}
...
\begin{frame}[t]
\frametitle{Backup: Коррекция нулевого уровня в кадре}
\vspace{0pt}
\begin{columns}
\column{0.5\textwidth}
\begin{minipage}[t][1\textheight]{\linewidth}
...
\begin{frame}[t]
\frametitle{Backup: работа алгоритма}
\vspace{0pt}
...
\begin{frame}[t]
\frametitle{Backup: влияние медианного алгоритма на распределение по заряду кластера }
\vspace*{10pt}
