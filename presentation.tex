...
\frametitle{Прототип детектора}
		\begin{minipage}[c]{0.59\linewidth}
			\centering
			\includegraphics[width=1\linewidth]{GEM_prototype.png} 
		...
		\includegraphics[width=1\linewidth]{Main_board.png} 
...
\begin{columns}
	...
	\column{0.5\linewidth}
	\begin{minipage}[t][1\textheight]{\linewidth}
		\centering \includegraphics[width=0.5\linewidth]{Readout_board.png}
	\end{minipage}
\end{columns}
\end{frame}
